...
“安心看股”是面向 A 股普通投资者的股票研究与决策验证工作台。它先把趋势、量价、关键位置、阶段表现、基本面与主要风险整理成一页可读结论；当用户准备交易时，再用个人规则和情景计算帮助验证计划。
...
**网页版是当前唯一正式交付平台。** 微信小程序、Android、iOS 和完整 PWA 已暂停；已有实验代码只冻结留档，不进入当前开发与验收。产品先提供日常可用的股票研究入口，再在交易意图出现时进入决策验证。主流程是：
...
- [Decision Layer 架构](DECISION_LAYER_ARCHITECTURE.md)
- [daily_stock_analysis 集成说明](integrations/README.md)
- [冻结后的 MVP 范围](MVP_SCOPE.md)
- [已暂停的平台工作](PAUSED_PLATFORM_WORK.md)
- [网页版核心流程](CORE_USER_FLOW.md)
- [匿名测试数据字段](USER_TEST_DATA_SCHEMA.md)
- [90 秒演示脚本](DEMO_SCRIPT.md)
- [MVP 完成报告](MVP_COMPLETION_REPORT.md)
- [未来 7 天网页版计划](NEXT_7_DAYS.md)
- [产品评审](PRODUCT_REVIEW.md)
- [2 分钟用户流程](USER_FLOW.md)
- [5 人用户测试计划](USER_TEST_PLAN.md)
- [产品评估指标](EVALUATION.md)
- [竞品价值分析](COMPETITOR_ANALYSIS.md)
- [商业模式假设](BUSINESS_MODEL.md)
- [评委评分与两周路线图](NEXT_TWO_WEEKS_ROADMAP.md)
