...
export function CapabilityGuide(){
  ...
  return <div className="capability-guide">
    ...
    <section className="capability-flow"><header><span>核心闭环</span><strong>Information → Decision</strong></header>{[
    ...
    <section className="capability-section" data-guide="capability-matrix"><header><div><span>当前交付</span><h3>能力不是一张静态路线图</h3><p>下列状态来自平台注册中心。新增、变更或停用能力后，知识索引会随版本更新。</p></div><Link href="/workspace">查看模块化工作台<ExternalLink /></Link></header>
