...
const PROVIDER_PRESETS={
  hkgai:{displayName:"我的 HKGAI",providerType:"compatible",baseUrl:"https://test-new-api.hkchat.app/v1",apiMode:"chat"},
  deepseek:{displayName:"我的 DeepSeek",providerType:"compatible",baseUrl:"https://api.deepseek.com/v1",apiMode:"chat"},
  openai:{displayName:"我的 OpenAI",providerType:"openai",baseUrl:"https://api.openai.com/v1",apiMode:"chat"},
  claude:{displayName:"我的 Claude",providerType:"anthropic",baseUrl:"https://api.anthropic.com/v1",apiMode:"native"},
  ollama:{displayName:"我的 Ollama",providerType:"compatible",baseUrl:"http://localhost:11434/v1",apiMode:"chat"},
  custom:{displayName:"自定义模型",providerType:"compatible",baseUrl:"",apiMode:"chat"},
} as const;
const DEFAULT_PROVIDER_DRAFT:ProviderDraft={...PROVIDER_PRESETS.hkgai,model:"",apiKey:"",capabilities:{conversation:true,workspaceCommand:true,preTradeCheck:true,etfAnalysis:true,portfolioRisk:true,quantRule:true,vision:false}};
...
function AISettingsSurface({ initialProviders,onProvidersChange }: { initialProviders: AIProviderProfile[];onProvidersChange:(providers:AIProviderProfile[])=>void }) {
  ...
  const selectPreset=(key:keyof typeof PROVIDER_PRESETS)=>{const preset=PROVIDER_PRESETS[key];setDraft((current)=>({...current,...preset,providerId:undefined,model:"",apiKey:""}));setFormResult(undefined);};
